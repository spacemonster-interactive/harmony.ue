...
public:
    ...
    UPROPERTY(EditAnywhere, Category="Gaussian Splat", meta=(DisplayName="Depth Offset Mode"))
    ...
    UPROPERTY(EditAnywhere, Category="Gaussian Splat", meta=(UIMin="-500.0", UIMax="500.0"))
    float SplatDepthOffset = 200.0f;

    // Local-space Z reference where Ground-Weighted depth offset is applied at full strength.
    UPROPERTY(EditAnywhere, Category="Gaussian Splat", meta=(DisplayName="Ground Offset Base Local Z", EditCondition="SplatDepthOffsetMode == EHarmonySplatDepthOffsetMode::GroundWeighted", EditConditionHides, UIMin="-100000.0", UIMax="100000.0"))
    ...
    UPROPERTY(EditAnywhere, Category="Gaussian Splat", meta=(DisplayName="Ground Offset Fade Height", EditCondition="SplatDepthOffsetMode == EHarmonySplatDepthOffsetMode::GroundWeighted", EditConditionHides, ClampMin="0.0", UIMin="0.0", UIMax="2000.0"))
